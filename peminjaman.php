...
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-md-12">
                <a href="?page=peminjaman_tambah" class="btn btn-warning "> <i class="fa fa-plus"></i> Tambah Peminjaman</a>
                                ...
                                <td>
                                    <?php  
                                        if($data['status_peminjaman'] != 'dikembalikan') {
                                            ...
                                            ?>
                                    <a href="?page=peminjaman_ubah&&id=<?php echo $data['id_peminjaman']; ?>" class="btn btn-warning mx-2">Ubah</a>

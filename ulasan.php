...
<div class="row">
    <div class="col-md-12">
        <a href="?page=ulasan_tambah" class="btn btn-warning mb-3">+ Tambah Data</a>
            ...
            $i = 1;
                ...
                while($data =mysqli_fetch_array($query)){
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="?page=ulasan_ubah&&id=<?php echo $data['id_ulasan']; ?>" class="btn btn-warning mx-2">Ubah</a>
